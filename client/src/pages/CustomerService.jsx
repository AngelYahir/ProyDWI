  ...
  return (
    <>
      ...
      <section className="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md bg-zinc-200 mt-5 mb-8">
        <h2 className="text-3xl font-semibold text-center">Tienes algun problema?</h2>
        <p className="mt-3 text-center">Lamentamos que tuvieras una mala experiencia, puedes comunicarte con uno de nuestro agentes de soporte para solucionar tu problema.</p>
        
        <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
            <a href="#" className="flex flex-col items-center px-4 py-3 transition-colors duration-200 transform rounded-md hover:bg-blue-200 dark:hover:bg-blue-500 hover:text-white">
            ...
            <a href="#" className="flex flex-col items-center px-4 py-3 transition-colors duration-200 transform rounded-md hover:text-white hover:bg-blue-200 dark:hover:bg-blue-500">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="mt-6 ">
            ...
            <div className="flex justify-center mt-6">
                <button className="px-4 py-2 text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">Enviar Mensaje</button>
            </div>
        </div>
      </section>
    </>
